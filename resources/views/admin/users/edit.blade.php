                                ...
                                <div class="form-content">
                                 @include('errors.list')
                                            ...
                                            <div class="form-group">
                                                <div class="inputer floating-label">
                                                    <div class="input-wrapper">
                                                        ...
                                                        {!! Form::label('represent', 'Representa A:', ['class' => 'control-label']) !!}
                                                    </div>
                                                </div>
                                            </div><!--.form-group-->
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="inputer floating-label">
                                                    <div class="input-wrapper">
                                                        ...
                                                        {!! Form::label('mobile_phone', 'Telefono Celular', ['class' => 'control-label']) !!}
                                                    </div>
                                                </div>
                                            </div><!--.form-group-->
                                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="inputer floating-label">
                                                    <div class="input-wrapper">
                                                        ...
                                                        {!! Form::label('street', 'Avenida', ['class' => 'control-label']) !!}
                                                    </div>
                                                </div>
                                            </div><!--.form-group-->
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="inputer floating-label">
                                                    <div class="input-wrapper">
                                                        ...
                                                        {!! Form::label('interior', 'Numero Interior', ['class' => 'control-label']) !!}
                                                    </div>
                                                </div>
                                            </div><!--.form-group-->
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                {!! Form::label('colony_id', 'Colonia', ['class' => 'control-label']) !!}
                                                <div class="input-wrapper">
                                            ...
                                            <div class="form-group">
                                                <div class="inputer floating-label">
                                                    <div class="input-wrapper">
                                                        ...
                                                        {!! Form::label('profession', 'Profesion', ['class' => 'control-label']) !!}
                                                    </div>
                                                </div>
                                            </div><!--.form-group-->
                                        </div>
